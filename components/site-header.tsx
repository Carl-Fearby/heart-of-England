...
export default function SiteHeader() {
  ...
  return <><header className="site-header" ref={header} onClick={event => { if ((event.target as HTMLElement).closest("a")) closeAll(); }} onKeyDown={event => {
    ...
    <div className="shell brand-row"><Link href="/" aria-label="Heart of England home"><ResilientImage priority sizes="200px" src="/images/heart-of-england-logo.png" alt="Heart of England" /></Link><div className="header-tools"><a href="tel:01676540333">01676 540333</a><Link className="enquire" href="/contact-us/">Make an enquiry ↗</Link></div>
      <details className="nav-mobile"><summary>Menu <span aria-hidden="true">+</span></summary><nav aria-label="Mobile navigation"><NavigationLinks /></nav></details>
    </div><nav className="shell primary-navigation" aria-label="Primary navigation"><NavigationLinks /></nav>
